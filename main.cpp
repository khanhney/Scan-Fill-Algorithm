...
{
    int ymax;  //tọa độ Y lơn nhất của cạnh
    float xofymin; //tọa độ X thấp nhất (chỉ cập nhật trong AET)
    float slopeinverse; //là độ dóc
}EdgeBucket;
...
{
    fp=fopen ("E:/Scanline2/PolyDino.txt","r");
    //fp=fopen ("E:/Scanline2/dongHo.txt","r");
